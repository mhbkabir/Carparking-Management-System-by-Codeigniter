...
****************************/
 ...
 public function view_sensor_list($sensor)
	{
	   $query  = $this->db->query('select c.controller_id, s.floor_id , s.sensor_id, c.controller_name, f.floor_name, s.sensor_name,s.sensorID from tbl_controller as c, tbl_floor as f, tbl_sensor as s where (s.floor_id=f.floor_id) AND (s.controller_id=c.controller_id)');
	   return  $query->result();
	}	
