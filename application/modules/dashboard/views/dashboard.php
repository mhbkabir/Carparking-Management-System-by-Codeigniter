    <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Log info</li>
          </ol>

            <div class="card mb-3">
              <div class="card-body">
               <form name ="userinput" action="<?php echo base_url()?>dashboard/search" method="post" onsubmit="return validation();">
                <div class="row">
                    <div class="col-md-2">
                    <div class="form-group" style="margin-bottom: 0">
                        <div class="form-row">
                            ...
                            <?php echo $sensor_id; ?>                         
                                 <select name="floor_id" id="floor_id" required="required" class="form-control" style="width:165px;">
                        ...
                        <div class="form-row">
                            <div class="form-label-group">
                              <div class="result"></div>
                                 <select name="controller_idd" class="form-control hide_controller_id" style="width:165px;">
                        ...
                        <div class="form-row">
                            <div class="form-label-group">
                              <div class="result2"></div>
                                 <select name="sensorid" class="form-control hide_sensor_id"  style="width:165px;">
          ...
          <div class="card mb-3">
           ...
           if(!empty($dashboard_data)) { 
            ...
            foreach($dashboard_data as $status_value) { ?>
					<tr>
